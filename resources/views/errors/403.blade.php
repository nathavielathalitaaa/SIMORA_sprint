...
<head>
    ...
    <title>403 — Akses Ditolak · SIMORA</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .error-num span { color: #E57373; }
        .divider {
            width: 48px; height: 3px;
            background: linear-gradient(90deg, #E57373, var(--color-text));
...
<body>
    <div class="card">
        ...
        <div class="error-num">4<span>0</span>3</div>
        <div class="divider"></div>
        <h1 class="error-title">Akses Ditolak</h1>
        <p class="error-desc">
            Anda tidak memiliki izin untuk mengakses halaman ini.<br>
            Hubungi HR Admin jika Anda merasa ini adalah kesalahan.
        </p>
        <div class="btn-group">
