...
<div class="flex items-center justify-between py-4">
    <div>
        <h5 class="text-base font-bold text-slate-900">Pengaturan Tanda Tangan Dokumen</h5>
        <p class="text-xs text-slate-500 mt-0.5">Konfigurasikan logo, nama organisasi, warna, dan font untuk dokumen yang dihasilkan sistem.</p>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2">
        <form action="{{ route('users.settings.document.update') }}" method="POST">
            @csrf
            <div class="ds-section">
                <div class="flex items-center gap-2 mb-4 pb-2 border-b border-slate-100">
                    ...
                    <h6 class="text-sm font-bold text-slate-900">Branding & Teks</h6>
                </div>

                <div class="mb-4">
                    <label class="block text-xs font-bold text-slate-600 mb-1">Nama Organisasi / Sekolah <span class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-600 mb-1">Jenis Font <span class="text-red-500">*</span></label>
                ...
                <div class="mb-5">
                    <label class="block text-xs font-bold text-slate-600 mb-1">Teks Kaki / Footer (Opsional)</label>
    ...
    <div class="lg:col-span-1">
        <div class="ds-section">
            ...
            <form action="{{ route('users.settings.document.logo') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-4">
